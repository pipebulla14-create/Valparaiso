...
REQUIRED: A summary of the intentions with which the data set was developed.</abstract>
  ...
  <links>
    <link name="SDE Feature Class" size="" url="Server=172.22.110.36; Service=5151; Database=sde; User=geosde; Version=SDE.DEFAULT" description="" format="" type="ArcSDE Connection" mimeType=""/>
  </links>
  <dates/>
  <fees></fees>
